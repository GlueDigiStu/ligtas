<?php
    ...
    if ( ! defined('FS_PHP_SDK_API__USER_AGENT'))
        define('FS_PHP_SDK_API__USER_AGENT', 'fs-php-' . Freemius_Api_Base::VERSION);

    $curl_version = curl_version();

    if ( ! defined('FS_PHP_SDK_API__PROTOCOL'))
        define('FS_PHP_SDK_API__PROTOCOL', version_compare($curl_version['version'], '7.37', '>=') ? 'https' : 'http');

    if ( ! defined('FS_PHP_SDK_API__ADDRESS'))
        define('FS_PHP_SDK_API__ADDRESS', FS_PHP_SDK_API__PROTOCOL . '://api.freemius.com');
    if ( ! defined('FS_PHP_SDK_API__SANDBOX_ADDRESS'))
        define('FS_PHP_SDK_API__SANDBOX_ADDRESS', FS_PHP_SDK_API__PROTOCOL . '://sandbox-api.freemius.com');
    ...
    if ( ! class_exists( 'Freemius_Api' ) ) {
        class Freemius_Api extends Freemius_Api_Base
        {
            ...
            public static $CURL_OPTS = array(
                ...
                CURLOPT_TIMEOUT        => 60,
                CURLOPT_USERAGENT      => FS_PHP_SDK_API__USER_AGENT,
            ...
            {
                return ($this->_sandbox ? FS_PHP_SDK_API__SANDBOX_ADDRESS : FS_PHP_SDK_API__ADDRESS) . $pCanonizedPath;
            }
