            ...
            <div class="dots-plugin-details">
                <div class="dots-header-left">
                    ...
                    <div class="plugin-name">
                        <div class="title"><?php echo esc_html( $plugin_name ); ?></div>
                    </div>
                    <span class="version-label <?php echo esc_attr( $plugin_slug ); ?>"><?php echo esc_html( $version_label ); ?></span>
                    <span class="version-number"><?php echo esc_html( $plugin_version ); ?></span>
                </div>
                    ...
                    <div class="button-dots">
                        ...
                        if ( wcpffc_fs()->is__premium_only() ) {
                            if ( wcpffc_fs()->can_use_premium_code() ) {
                                ...
                                ?>
                                <a class="dots-upgrade-btn" target="_blank" href="javascript:void(0);"><?php esc_html_e('Upgrade Now', 'woocommerce-conditional-product-fees-for-checkout'); ?></a>
                                <?php
                            }
                        } else {
                            ?>
            ...
            <div class="dots-bottom-menu-main">
                <div class="dots-menu-main">
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a class="dotstore_plugin <?php echo esc_attr($wcpfc_settings_menu); ?>" href="<?php echo esc_url( add_query_arg(array('page' => 'wcpfc-global-settings'), admin_url('admin.php')) ); ?>"><?php esc_html_e('Settings', 'woocommerce-conditional-product-fees-for-checkout'); ?></a>
                            </li>
                            <?php 
                            if ( wcpffc_fs()->is__premium_only() && wcpffc_fs()->can_use_premium_code() ) {
                                ...
                                ?>
                                <li>
                                    <a class="dotstore_plugin dots_get_premium <?php echo esc_attr($whsm_free_dashboard); ?>" href="<?php echo esc_url(add_query_arg(array('page' => 'wcpfc-upgrade-dashboard'), admin_url('admin.php'))); ?>"><?php esc_html_e('Get Premium', 'woocommerce-conditional-product-fees-for-checkout'); ?></a>
                                </li>
                                <?php
                            }
                            ?>
                ...
                <div class="dots-getting-started">
                    <nav>
                        <ul>
                            <li>
                                <a href="<?php echo esc_url(add_query_arg(array('page' => 'wcpfc-pro-get-started'), admin_url('admin.php'))); ?>" class="<?php echo esc_attr($wcpfc_get_started); ?>"><?php esc_html_e('Getting Started', 'woocommerce-conditional-product-fees-for-checkout'); ?></a>
                            </li>
                        </ul>
                    </nav>
                </div>
