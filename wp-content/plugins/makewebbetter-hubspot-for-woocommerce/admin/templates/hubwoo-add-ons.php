...
<div class="hubwoo-gs-wrap hubwoo-gs-wrap--gen">
	...
	<!-- <div class="hubwoo-box-card hubwoo-box-n-card">
		<div class="hubwoo-box-n-card">
			<div class="hubwoo-box-n-card__content">
				<div class="hubwoo-fields-header hubwoo-common-header">
					<h2><?php esc_html_e('HubSpot Free Audit', 'makewebbetter-hubspot-for-woocommerce'); ?></h2>
				</div>
				<div class="hubwoo-box-card__subtitle">
					<?php
					esc_html_e('Start afresh with a new setup! Turn the momentum into organized operations with a FREE HubSpot audit and CRM setup. Get an expert-led CRM consultation and implementation on demand.', 'makewebbetter-hubspot-for-woocommerce');
					?>
				</div>
			</div>
			<div class="hubwoo-box-n-card__btn">
				<div>
					<a href="https://makewebbetter.com/festive-offer/?utm_source=hswoo-org&utm_medium=plugin-backend+&utm_campaign=festive-offer2025" target="_blank" class="hubwoo__btn "><?php esc_html_e('Get Started', 'makewebbetter-hubspot-for-woocommerce'); ?></a>
				</div>
			</div>
		</div>
	</div> -->
