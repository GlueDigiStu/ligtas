...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/main.min.css?v=<?php echo filemtime(get_template_directory() . '/css/main.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/style.css?v=<?php echo filemtime(get_template_directory() . '/style.css'); ?>">
