<?php 
    ...
    if(is_admin()) {
        ...
        $img = get_field('image');
?>
        <div class="top_img <?php echo $color.' '.get_field('indents'); ?><?php echo ligtas_manual_padding_class(); ?>" id=<?php if(get_field('section')) { echo str_replace(' ', '-', strtolower(get_field('section')));} ?><?php echo ligtas_manual_padding_style(); ?>>
