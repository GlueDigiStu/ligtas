...
if (is_admin()) {
    ...
    ?>
    <div class="content_section <?php echo $color . ' ' . get_field('indents'); ?><?php echo ligtas_manual_padding_class(); ?>" id=<?php if (get_field('section')) {
                        ...
                        <div class="team_item fade_in">
                            ...
                            <div class="team_item_bottom" id="team_item_bottom">
                                ...
                                <div class="team_item_img_wrap">
                                    ...
                                    <?php } else { ?>
                                        <div class="team_item_img" style="margin-left: auto;">
                                            <img src="<?php bloginfo('template_url'); ?>/images/bio_placeholder.png"
                                                 alt="placeholder image">
                                        </div>
                                    <?php } ?>
                                    <?php if (get_sub_field('linkedin')) { ?>
                                        <a class="team_item_soc" href="<?php echo get_sub_field('linkedin'); ?>"
                                           target="_blank">
