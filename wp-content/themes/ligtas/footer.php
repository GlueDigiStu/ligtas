...
<div id="mini-cart-panel"
     style="display:none;position:fixed;top:20px;right:20px;z-index:99999;width:320px;background:#fff;border-radius:10px;box-shadow:0 8px 32px rgba(41,18,97,0.2);padding:24px;">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        ...
        <button id="mini-cart-close"
                style="background:none;border:none;font-size:28px;cursor:pointer;color:#291261;line-height:1;padding:0;">
            &times;
        </button>
    </div>
    <div id="mini-cart-items" style="margin-bottom:12px;"></div>
    <div id="mini-cart-total"
         style="border-top:2px solid #a27fff;padding-top:12px;font-weight:bold;color:#291261;font-size:16px;"></div>
    <div style="display:flex;gap:12px;margin-top:16px;">
        <a id="mini-cart-link" href="#" class="btn"
           style="flex:1;text-align:center;justify-content:center;min-width:0;">View Cart</a>
